...
*Última actualización de este archivo: 15 de julio de 2026. Backlog PDF CERRADO (M1 + M2 + tagline verificado). El área comercial revisará el formato — se esperan ajustes menores. Siguientes decisiones: revisión comercial, campo `celular` en perfiles, H-008, y activación de `sigp_f1_enabled`. Versión: 1.5.5.*
