...
- **1.5 🔄 Refinamientos comerciales — EN CURSO.** Cuatro puntos validados por Giovanny (11-jul-2026):
  ...
  4. ⏳ **Máximo 2 decimales en toda la UI y el PDF** (cantidades, valores, porcentajes, rendimientos, totales); la precisión completa se conserva internamente (snapshots y cálculos no cambian).
...
*Última actualización de este archivo: 12 de julio de 2026, tras F1.5 punto 2 (actividades como entidad propia). Pendientes F1.5: puntos 1, 3, 4 + backlog PDF. Versión: 1.5.0.*
