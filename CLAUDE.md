...
*Última actualización de este archivo: 16 de julio de 2026 — **SIGP F1 EN PRODUCCIÓN** (`sigp_f1_enabled` activado) y panel renombrado a "Panel del Sistema de Gestión Integral" (PR #13). Pendientes: ajustes que pida el área comercial en uso real, campo `celular` en perfiles, H-008 (hardening Storage antes de roles externos F3+). Versión: 1.6.0.*
