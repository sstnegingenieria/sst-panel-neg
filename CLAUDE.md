...
- **1.3-bis ⏳ Shell del panel responsive** — siguiente tarea (drawer + hamburguesa en móvil). **Transversal a todo el panel** (Layout/Sidebar/Header, compartidos con SST) → con su propia regresión SST. Surge de la validación de F1.3: la captura es mobile-first pero la navegación del shell es tipo PC.
...
*Última actualización de este archivo: 07 de julio de 2026, tras el cierre de la iteración F1.3 (Visitas técnicas). Versión: 1.3.*
