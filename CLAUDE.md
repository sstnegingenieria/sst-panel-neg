...
- Read: roles `gerencia_administrativa`, `gerencia_general`, `director_proyectos`, `gerencia_comercial`, `admin`, `gestion_integral`.
...
| `gerencia_comercial` | Solicitudes, cotizaciones, aprobaciones comerciales |
...
*Última actualización de este archivo: 02 de julio de 2026. Versión: 1.0.*
