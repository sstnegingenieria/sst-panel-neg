...
*Última actualización de este archivo: 15 de julio de 2026, tras M2 (robustez multipágina del PDF). Pendiente del backlog PDF: solo el tagline del asset `logo-neg-full.png` (a confirmar por Giovanny). El área comercial revisará el formato — se esperan ajustes menores. Versión: 1.5.4.*
