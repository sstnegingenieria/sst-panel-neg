...
// Los tests de patchSolicitudAceptada se retiraron con la función: la
// transición vive ahora SOLO en functions/crearProyecto.js (§16 ii) y se
// valida en la batería E2E del emulador (SB4).
