...
export default function ComprasReembolsos({ proyecto, puedeGestionar, reload }: Props) {
  ...
  // ⛔ 17-sep (barrido post-P2-2, arreglo #2): en un proyecto MIGRADO los
  // reembolsos viven EN cada asignación — un registro aquí caería al padre,
  // donde ni el indicador ni la liquidación por asignación lo leen (pérdida
  // silenciosa con consecuencia financiera). Este formulario queda solo-legacy;
  // la captura buena es el botón "＋ Reembolso" de la tarjeta del contratista.
    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
        ...
        <p className="mt-1 text-sm text-gray-600 bg-gray-50 rounded-lg px-3 py-2">
          ...
          Regístralos con el botón <strong>"＋ Reembolso"</strong> en la tarjeta del contratista
          correspondiente (sección "Contratistas y cobertura del alcance" — el formulario dice
          de quién es el reembolso). Los históricos no se borraron: se migraron a la asignación.
        </p>
      </div>
    )
  }
