...
const navItems = [
  ...
  // Bloque 3a (23-jul-2026): gate SST previo a la liquidación — cola de
  // proyectos facturados/pagados donde SST verifica al contratista.
  {
    to: '/verificacion-contratistas',
    label: 'Verificación SST',
    ve: veVerificacionSstUI,
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
...
const sigpNavItems: {
  ...
  // UX jul-2026: "LPU" salió del sidebar — la gestión vive en el detalle de
  // cada cliente (pestaña "Listas de precios"). /sigp/lpus redirige a Clientes.
  {
    to: '/sigp/solicitudes',
    label: 'Solicitudes',
    icon: (
  ...
  // #2b — el Catálogo NEG vive como PESTAÑA de Cotizaciones (reorg de
  // navegación) — sin ítem propio; /sigp/catalogo redirige.
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 py-4 space-y-1 px-2 overflow-y-auto">
        ...
        {/* Sección ADMINISTRATIVA (Bloque 1, 22-jul-2026) — grupo propio, fuera
